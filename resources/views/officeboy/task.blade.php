        ...
        <div class="mt-16">
            <div class="gap-4 mb-4">
                <div class="my-4 p-8 bg-gray-800 shadow-md rounded-lg">
                    <h2 class="text-2xl font-bold mb-4 text-white">Tugas Anda</h2>
                    @if (session('success'))
                    ...
                    @if (session('error'))
                        <div class="bg-red-500 rounded-md px-2 py-2 mb-2">
                            {{ session('error') }}
                        </div>
                    @endif
                    ...
                    <table
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="py-2 px-4">Catatan Tugas</th>
                                <th class="py-2 px-4">Catatan OB</th>
                                <th class="py-2 px-4">Kirim Laporan</th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse ($tasks as $task)
                                <tr>
                                    <td class="py-4 px-4 mb-2 text-center">{{ optional($task->building)->name }}</td>
                                    <td class="py-4 px-4 mb-2 text-center">{{ optional($task->floor)->name }}</td>
                                    <td class="py-4 px-4 mb-2 text-center">{{ optional($task->room)->name }}</td>
                                    <td class="py-4 px-4 mb-2 text-center">{{ optional($task->shift)->name }}</td>
                                    <form action="{{ route('office_boy.submit_report') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <td class="py-4 px-4 mb-2 text-center">
                                            <input type="hidden" name="monitoring_id" value="{{ $task->id }}">
                                            <input type="file" name="proof_photo" required>
                                        </td>
                                        <td class="py-4 px-4 mb-2 text-center">
                                            <textarea name="catatan_tugas" placeholder="Catatan Tugas"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full p-2.5"></textarea>
                                        </td>
                                        <td class="py-4 px-4 mb-2 text-center">
                                            <textarea name="catatan_ob" placeholder="Catatan OB"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full p-2.5"></textarea>
                                        </td>
                                        <td class="py-4 px-4 mb-2 text-center">
                            ...
                            @empty
                                <tr>
                                    <td colspan="9">Tidak ada tugas yang ditemukan.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
