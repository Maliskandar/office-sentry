        ...
        <div class="mt-16">
            <div class="gap-4 mb-4">
                <div class="my-4 p-8 bg-gray-800 shadow-md rounded-lg">
                    ...
                    @if (session('success'))
                        <div class="bg-green-500 rounded-md px-2 py-2 mb-2">
                            {{ session('success') }}
                        </div>
                    @endif
                    ...
                    <table
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="py-2 px-3">Sumber Informasi</th>
                        ...
                        <tbody>
                            @foreach ($trackings as $tracking)
                                <tr>
                                    <td class="py-2 px-3 text-center">{{ $tracking->date }}</td>
                                    <td class="py-2 px-3 text-center">{{ $tracking->sumber_informasi }}</td>
                                    <td class="py-2 px-3 text-center">{{ $tracking->catatan }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    <div class="flex item-center">
                        <a href="{{ url('/dashboard/office_boy') }}"
                            class="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:border-red-300 mt-2">
                            Kembali
                        </a>
                    </div>
                </div>
