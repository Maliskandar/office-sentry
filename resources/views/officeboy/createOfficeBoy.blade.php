{{-- resources/views/create-office-boy.blade.php --}}
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Registrasi Akun Office Boy</title>
    ...
    <div class="p-4 sm:ml-64">
        <div class="mt-16">
            <div class="gap-4 mb-4">
                <div class="w-full my-4 p-8 bg-gray-800 shadow-md rounded-lg mt-16">
                    <h2 class="text-2xl font-bold mb-4 text-white">Registrasi Akun Office Boy</h2>
                    @if (session('success'))
                    ...
                    @endif
                    <form method="POST" action="{{ url('/store-office-boy') }}">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" name="password" id="password"
                                placeholder="Password akan digenerate setelah registrasi" readonly
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full p-2.5">
                        </div>
                        <div class="mb-4">
                            <label for="phone" class="block text-sm font-medium text-gray-600">Nomor
                                Telepon:</label>
