    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4 w-auto">
            ...
            <div
                ...
                <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Daftar Tugas</h2>
            ...
            <div
                ...
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Memberikan laporan kepada Office
                    Boy untuk menjadi bahan Evaluasi dari tugas harian yang diberikan.</p>
                <a href="/pengawas/tracking"
                    class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">
                    <svg class="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
            ...
            <div
                ...
                <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Rolling 3 bulan</h2>
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Fungsi untuk me-reset tugas harian
                    Office Boy.</p>
                <a href="{{ route('assign.random') }}"
                    class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">
                    <svg class="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true"
