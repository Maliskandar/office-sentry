        ...
        <div class="mt-16">
            <div class="gap-4 mb-4">
                <div class="my-4 p-8 bg-gray-800 shadow-md rounded-lg">
                    <h2 class="text-2xl font-bold mb-4 text-white">Hasil Tracking Office Boy</h2>
                    <table
                        ...
                        <thead>
                            <tr>
                                <th class="py-2 px-4">Nama Ofiice Boy</th>
                                <th class="py-2 px-4">Sumber Informasi</th>
                        ...
                        <tbody>
                            @foreach ($trackings as $tracking)
                                <tr>
                                    <td class="py-4 px-4 mb-2 text-center">{{ $tracking->officeBoy->nama_lengkap }}
                                    </td>
                                    <td class="py-4 px-4 mb-2 text-center">{{ $tracking->sumber_informasi }}</td>
                                    <td class="py-4 px-4 mb-2 text-center">{{ $tracking->building->name }}</td>
                                    <td class="py-4 px-4 mb-2 text-center">{{ $tracking->floor->name }}</td>
                                    <td class="py-4 px-4 mb-2 text-center">{{ $tracking->room->name }}</td>
                                    <td class="py-4 px-4 mb-2 text-center">{{ $tracking->date }}</td>
                                    <td class="py-4 px-4 mb-2 text-center">{{ $tracking->catatan }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    <div class="flex item-center mt-4">
                        <a href="{{ url('/pengawas/tracking') }}"
