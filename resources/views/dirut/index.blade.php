            ...
            <div class="gap-4 ">
                <div class="">
                    <div class="my-4 p-8 bg-gray-800 shadow-md rounded-lg">
                        ...
                        @endif
                        <!-- Search Form -->
                        <form action="{{ route('dirut.index') }}" method="GET" class="mb-4">
                            <div class="flex items-center">
                        ...
                        <table
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="py-2 px-4">Status Profile</th>
                                    <th class="py-2 px-4">Detail</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($officeBoys as $key => $officeBoy)
                                    <tr class="hover:bg-gray-500 transition-colors duration-300">
                                        <td class="py-4 px-4 mb-2 text-center">{{ $key + 1 }}</td>
                                        ...
                                        <td class="py-4 px-4 mb-2 text-center">
                                            <a href="{{ route('dirut.office-boys.show', $officeBoy->id) }}"
