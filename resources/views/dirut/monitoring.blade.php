            ...
            <div class="gap-4 mb-4">
                <div class="">
                    <div class="my-4 p-8 bg-gray-800 shadow-md rounded-lg">
                        <h2 class="text-2xl font-bold mb-4 text-white">Daftar Tugas Office Boy</h2>
                        <!-- Pencarian berdasarkan tanggal -->
                        <form action="{{ route('kabag_urdal.filter') }}" method="GET">
                            @csrf
                            <div class="flex justify-start mb-4">
                                <input type="date" name="date"
                                    class="px-1 py-1 rounded-md bg-gray-700 text-white" required>
                                <button type="submit"
                        ...
                        <!-- Form Pencarian -->
                        <form action="{{ route('kabag_urdal.monitorings') }}" method="GET">
                            ...
                            <tbody>
                                @foreach ($monitorings as $monitoring)
                                    <tr class="hover:bg-gray-500 transition-colors duration-300">
                                        <td class="py-4 px-4 mb-2 text-center">{{ $monitoring->officeBoy->nik }}</td>
                                        <td class="py-4 px-4 mb-2 text-center">
                                            {{ $monitoring->officeBoy->nama_lengkap }}</td>
                                        <td class="py-4 px-4 mb-2 text-center">{{ $monitoring->building->name }}</td>
                                        <td class="py-4 px-4 mb-2 text-center">{{ $monitoring->floor->name }}</td>
                        ...
                        <div class="flex item-center">
                            ...
                            <a href="{{ url('/dashboard/kabag_urdal') }}"
                                class="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:border-red-300 mr-2">
                                Kembali
                            </a>
                        </div>
                    </div>
