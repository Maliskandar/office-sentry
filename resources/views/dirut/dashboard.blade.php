...
<head>
    ...
    <title>Dashboard Dirut Umum</title>
    ...
    <div class="p-4 sm:ml-64">
        <div class="mt-16">
            <div class="gap-4 mb-4">
                <div
                    class="w-full flex items-center justify-between bg-gradient-to-b from-blue-50 to-transparent dark:from-blue-900 shadow-lg text-white rounded-lg px-6 mr-6 mt-6 py-8">
        ...
        <!-- Status Akademik End -->
        <div class="grid grid-cols-2 gap-4 mb-4 w-auto">
            <div
                ...
                <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Registrasi Akun Office Boy</h2>
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Proses Registrasi Akun Office Boy
                    ini tidak hanya memudahkan administrasi dan manajemen sumber daya manusia tetapi juga meningkatkan
                    efisiensi dan transparansi operasional. </p>
                <a href="/createOfficeBoy"
            ...
            <div
                ...
                <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Data Office Boy</h2>
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Berisi semua data nama Office Boy
                    .</p>
                <a href="/dirut/office-boys"
                    class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">
                    <svg class="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true"
            ...
            <div
                ...
                <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Tracking Office Boy</h2>
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Melihat riwayat pelaporan tugas
                    yang diberikan oleh pengawas dari laporan karyawan kantor.</p>
                <a href="/dirut/tracking-results"
                    class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">
            ...
            <div
                ...
                <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Daftar Tugas Office Boy</h2>
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Tugas-tugas harian Office Boy.</p>
                <a href="/dirut/monitorings"
                    class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">
                    <svg class="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
